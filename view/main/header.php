            ...
            <div class="col-auto">
              ...
              <div class="u-basket d-inline-block g-valign-middle g-pt-2">
                ...
                data-dropdown-type="css-animation" data-dropdown-duration="300" data-dropdown-hide-on-scroll="false" data-dropdown-animation-in="fadeIn" data-dropdown-animation-out="fadeOut">
                  <span class="u-badge-v1--sm g-color-white g-bg-primary g-rounded-50x">1</span>
                ...
                <div id="basket-bar" class="u-basket__bar u-dropdown--css-animation u-dropdown--hidden g-text-transform-none g-bg-black g-brd-top g-brd-2 g-brd-primary g-color-main g-mt-13" aria-labelledby="basket-bar-invoker">
                  <div class="js-scrollbar g-height-40">
                    ...
                    <div class="u-basket__product g-brd-white-opacity-0_3">
                      <div class="row align-items-center no-gutters">
                        ...
                        <a href="#" class="g-color-white g-color-white--hover g-text-underline--none--hover">Taxi 5 places</a>
                      </h6>
        ...
        <nav class="navbar navbar-expand-lg">
          <div class="container">
            ...
            <a href="../../../index.html" class="navbar-brand">
              <img src="<?php echo  BASE_URL_THEME; ?>assets/img/logo2.png" alt="TAXI AT THE PIER">
            </a>
            <!-- End Logo -->

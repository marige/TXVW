        ...
        <section class="timeline">
            ...
            <div class="row">
                <!-- 1 элемент -->
                <div class="col-12 col-sm-6  card g-brd-gray-light-v7 u-card-v1 g-mb-30 timeline-wrapper">
                    <div class="timeline-item card g-brd-gray-light-v7 u-card-v1 g-mb-30">

<!-- Tickets Card -->
            <div class="col-xl-8">
              ...
              <div class="card g-brd-gray-light-v7 g-mb-30">
                <header class="media g-pa-15 g-pa-25-30-0--md g-mb-20">
                  <h3 class="text-uppercase g-font-size-12 g-font-size-default--md g-color-black mb-0">ORDER N°</h3>
                </header>
                  ...
                  <section>
                    <div class="media">
                      <div class="media-body g-mb-15">
                        <h3 class="g-font-weight-300 g-font-size-16 g-color-black g-mb-5">MEETING AT </h3>
                    ...
                    <div class="media">
                      <div class="media-body align-self-center" href="#">
                        <span class="u-tags-v1 text-center g-width-140 g-bg-lightblue-v3 g-color-white g-brd-around g-brd-lightblue-v3 g-rounded-50 g-py-4 g-px-15">meeting done</span>
                      </div>
          ...
          <span class="g-font-weight-300 g-font-size-12 g-font-size-default--md g-color-gray-dark-v6 g-ml-4 g-ml-8--md">45 Min <span class="g-hidden-md-down">ago</span></span>
                  ...
                  <section>
                    <div class="media">
                      <div class="media-body g-mb-15">
                        <h3 class="g-font-weight-300 g-font-size-16 g-color-black g-mb-5">TRIP RUNNING</h3>
          ...
          <span class="g-font-weight-300 g-font-size-12 g-font-size-default--md g-color-gray-dark-v6 g-ml-4 g-ml-8--md">15 Min <span class="g-hidden-md-down">ago</span></span>
                  ...
                  <section>
                    <div class="media">
                      <div class="media-body g-mb-15">
                        <h3 class="g-font-weight-300 g-font-size-16 g-color-black g-mb-5">ENDING TRIP</h3>
                    ...
                    <div class="media">
                      <div class="media-body align-self-center" href="#">
                        <span class="u-tags-v1 text-center g-width-140 g-bg-primary g-color-white g-brd-around g-brd-primary g-rounded-50 g-py-4 g-px-15">COMPLETED</span>
                      </div>

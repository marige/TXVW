...
<form class=""  method="POST" action="/client/pu_save_order">  
    ...
    <h3 class="d-flex align-self-center text-uppercase g-font-size-12 g-font-size-default--md g-color-black g-mb-20">Make an Order</h3>
        <div class="g-mb-30">
            ...
            <div class="form-group u-select--v3 g-pos-rel g-brd-gray-light-v7 g-rounded-25 mb-0">
                <select name="iddestination" class="js-select u-select--v3-select u-sibling w-100" required="required" title="Placeholder" style="display: none;" tabindex="-98"><option  value=""></option>
        ...
        <div class="g-mb-30">
            ...
            <div class="form-group u-select--v3 g-pos-rel g-brd-gray-light-v7 g-rounded-25 mb-0">
                <select name="iditinerary" class="js-select u-select--v3-select u-sibling w-100" required="required" title="Placeholder" style="display: none;" tabindex="-98">
                    <option  value=""></option>
        ...
        <div class="g-mb-30">
            ...
            <div class="form-group u-select--v3 g-pos-rel g-brd-gray-light-v7 g-rounded-25 mb-0">
                <select name="idtaxi" class="js-select u-select--v3-select u-sibling w-100" required="required" title="Placeholder" style="display: none;" tabindex="-98"><option  value=""></option>
            ...
            <div class="g-brd-around g-brd-gray-light-v7 g-rounded-4 g-pa-20 g-mb-30">
              <div class="form-group mb-0 g-max-width-400">
                <div id="datepickerWrapper" class="u-datepicker-right u-datepicker--v3 g-pos-rel w-100 g-cursor-pointer g-brd-around g-brd-gray-light-v7 g-rounded-4">
                    <input name="date_choose" required class="js-range-datepicker w-100 g-bg-transparent g-font-size-12 g-font-size-default--md g-color-gray-dark-v6 g-pr-80 g-pl-15 g-py-9" type="text" placeholder="Select Date" data-rp-wrapper="#datepickerWrapper" data-rp-date-format="d-m-Y">

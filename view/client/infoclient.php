            ...
            <div class="col-xl-4">
              ...
              <div class="card g-brd-gray-light-v7 text-center g-pt-40 g-pt-60--md g-mb-30">
                <header class="g-mb-30">
                  ...
                  <em class="g-font-style-normal g-font-weight-300 g-color-gray-dark-v6">Martinique</em>
                </header>

                <section class="row no-gutters g-brd-top g-brd-gray-light-v4">
                  <div class="col-6 g-py-10 g-py-25--md">
                    <strong class="d-block g-font-weight-500 g-font-size-18 g-color-black">10</strong>
                    <span class="g-font-weight-300 g-color-gray-dark-v6">Orders</span>
                  </div>

                  <div class="col-6 g-brd-left--md g-brd-gray-light-v4 g-py-10 g-py-25--md">
                    <strong class="d-block g-font-weight-500 g-font-size-18 g-color-black">1</strong>
                    <span class="g-font-weight-300 g-color-gray-dark-v6">Level</span>
                  </div>
                </section>
              </div>
              <!-- End User Card -->
